...
const Widget = () => {
  ...
  return (
    <div className="relative w-full max-w-[400px] z-[1] drop-shadow-[0_10px_6px_rgba(0,0,0,0.31)] bg-gray-900 rounded-xl border-2 border-purple-500">
      <div className="p-5">
        <p className="text-center text-purple-400 font-gs-eb text-xl mb-4">Buy $LYRA Presale</p>

        <div className="w-full mx-auto">
          <div className="text-purple-500 flex items-center justify-between w-full counter bg-gray-800 rounded-t-[15px]">
            <div className="min-w-[70px] py-[7px] px-[10px] text-center flex items-center justify-center flex-col">
              <div className="text-purple-300 text-sm font-semibold leading-[30px] font-gs-sb">Days</div>
              <div className="text-[28px] font-semibold leading-[1] font-gs-sb">
                {time.days < 10 ? `0${time.days}` : time.days}
              </div>
            </div>
            ...
            <div className="min-w-[70px] py-[7px] px-[10px] text-center flex items-center justify-center flex-col">
              <div className="text-purple-300 text-sm font-semibold leading-[30px] font-gs-sb">Hours</div>
              <div className="text-[28px] font-semibold leading-[1] font-gs-sb">
                {time.hours < 10 ? `0${time.hours}` : time.hours}
              </div>
            </div>
            ...
            <div className="min-w-[70px] py-[7px] px-[10px] text-center flex items-center justify-center flex-col">
              <div className="text-purple-300 text-sm font-semibold leading-[30px] font-gs-sb">Minutes</div>
              <div className="text-[28px] font-semibold leading-[1] font-gs-sb">
                {time.minutes < 10 ? `0${time.minutes}` : time.minutes}
              </div>
            </div>
            ...
            <div className="min-w-[70px] py-[7px] px-[10px] text-center flex items-center justify-center flex-col">
              <div className="text-purple-300 text-sm font-semibold leading-[30px] font-gs-sb">Seconds</div>
              <div className="text-[28px] font-semibold leading-[1] font-gs-sb">
                {time.seconds < 10 ? `0${time.seconds}` : time.seconds}
              </div>
            </div>
          ...
          <p className="bg-purple-600 text-white rounded-b-[15px] text-[11px] tracking-[1px] text-center py-[2px] uppercase font-gs-sb">
            Presale ends in
          </p>
        </div>

        <div className="mt-3 w-full mx-auto">
          <p className="text-purple-400 relative tracking-[1.5px] text-sm text-center mb-2 font-gs-m before:content-[''] before:w-[20%] before:h-[1px] before:bg-gray-700 before:absolute before:left-0 before:top-1/2 after:content-[''] after:w-[20%] after:h-[1px] after:bg-gray-700 after:absolute after:right-0 after:top-1/2">
            1 $LYRA = {rate} SOL
          </p>
            ...
            <button
              ...
              className={`w-full min-h-10 py-[9px] text-white rounded-[30px] text-[23px] font-semibold font-gs-sb flex items-center justify-center gap-2 uppercase border-2 ${
                activeTab === "eth"
                  ...
                  : "border-transparent hover:border-purple-500 bg-gray-700 hover:bg-gray-800"
              } transition-all duration-200`}
            >
              <div className="w-[30px] h-[30px]">
                <img
            ...
            <div>
              {activeTab === "eth" && (
                <div>
                  ...
                  <div className="relative min-h-11 flex justify-between items-center gap-1 rounded-[30px] px-[15px] border-2 border-purple-500">
                    <input
                      type="number"
                      placeholder="0"
              ...
              <div className="relative min-h-11 flex justify-between items-center gap-1 rounded-[30px] px-[15px] border-2 border-purple-500">
                ...
                <div className="">
                  <img
                    ...
                    width={28}
                    height={28}
                    className="rounded-full border-2 border-purple-500 shadow-none w-[28px] h-[28px]"
                  />
                </div>
              </div>
            </div>
          ...
          <div>
            <div className="text-purple-300 text-[17px] font-gs-sb text-center w-full mt-4 mx-auto">
              Trouble connecting? You can also send SOL to this wallet:
            </div>
            <button
              onClick={handleCopyAddress}
              className="text-purple-400 underline hover:text-purple-300 text-[17px] font-gs-sb text-center w-full mt-4 mx-auto"
            >
              F9ax9qQrFx.....QrVh2HDedW
            </button>
            <div className="text-sm text-center mt-4 flex items-center justify-center">
              <p className="text-purple-300">Powered by</p>
